...
<html lang="en">
	<head>
		...
		{!!Html::style('plugins/justified-gallery/justifiedGallery.css')!!}
		{!!Html::style('css/style_v2.css')!!}
		{!!Html::style('plugins/chartist/chartist.min.css')!!}
							...
							<li class="dropdown">
								<a href="#" class="dropdown-toggle account" data-toggle="dropdown">
									...
									<div class="user-mini pull-right">
										<span class="welcome">Bienvenidos,</span>
										<span>José Luis</span>
									</div>
								</a>
